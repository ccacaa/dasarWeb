...
if (!empty($_SESSION['username'])) {
    ...
    if (!empty($_GET['jabatan'])) {
        ...
        if (mysqli_query($koneksi, $query)) {
            pesan('success', "Jabatan baru diatmbahkan!");
        } else {
            pesan('danger', "Menambahkan jabatan baru gagal, karena " . mysqli_error($koneksi));
        }
        ...
        if (mysqli_query($koneksi, $query)) {
            ...
            pesan('danger', "Menabahkan Anggota Karena: " .  mysqli_error($koneksi));
        }
